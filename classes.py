...
# test_text_1 = "Забрать 3 Телефон из shop_1"
# test_text_2 = "Доставить 12 Телевизор из storage_1 в shop_1"
# req = Request(test_text_2)
# req.move()
# print(storage_1)
# print(shop_1)

# storage_1 = Store(items={"Телефон": 10, "Компьютер": 20}, capacity=50)
